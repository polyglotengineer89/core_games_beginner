...
>> ACORN.GetPlayer
    ...
    GetPlayer("ant!") -- Returns the player with the exact username 'ant' (Not case sensitivTestPrinte)
...
ACORN.TestPrint = function(str)
    print("This is Print".. str)
    return str
end
