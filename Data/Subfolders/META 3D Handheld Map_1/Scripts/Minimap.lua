...
local WorldObjects = script:GetCustomProperty("WorldObjects"):WaitForObject()

local worldShapes = WorldObjects:FindDescendantsByType("StaticMesh")
local worldTexts = WorldObjects:FindDescendantsByType("WorldText")
